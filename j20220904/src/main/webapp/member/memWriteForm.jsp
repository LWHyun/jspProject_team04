                                            ...
                                            <div class="term-detail-wrap">
                                                <ol class="term-list">
                                                    <li>
                                                        <span class="term-head">제1조 (목적) </span>
                                                        <ul class="term-sub-list">
                                                            <li>이 약관은 ㈜신사몰(이하 "당사"라 함)가 운영하는 통합 사이버몰인 A-RT닷컴(http://www.a-rt.com) (이하 "닷컴"이라 함)을 통하여 제공하는 전자지급결제대행서비스, 결제대금예치서비스 및 선불전자지급수단(‘포인트’, ‘쿠폰’)의 발행 및 관리 서비스(이하 통칭하여 ‘전자금융거래서비스’라 합니다)를 이용자가 이용하는 경우, ‘회사’와 이용자간 전자금융거래의 법률관계를 정함에 그 목적이 있습니다.</li>
                                                        </ul>
                                                    </li> 
                                                    <li>
                                                        <span class="term-head">제2조 (정의)</span>

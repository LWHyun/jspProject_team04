                ...
                <form action="${pageContext.request.contextPath }/member/write.do" id="memJoinForm" class="memJoinForm" method="post">
                    ...
                    <div class="contents-inner join-wrap">
                                                ...
                                                <ol class="term-list">
                                                    <li>
                                                        ...
                                                        <ul class="term-sub-list">
                                                            <li>이 약관은 (주)신사몰 회사(이하 "회사"라 함)가 운영하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 회사와 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.</li>
                                                        </ul>
                                                    </li>
                                                    <li>
                                            ...
                                            <div class="term-detail-wrap">
                                                <ol class="term-list">
                                                    <li>
                                                        <span class="term-head">제1조 (목적) </span>
                                                        <ul class="term-sub-list">
                                                            <li>이 약관은 ㈜신사몰(이하 "당사"라 함)가 운영하는 사이버몰인 신사몰닷컴(http://www.sinsamall.com) (이하 "닷컴"이라 함)을 통하여 제공하는 전자지급결제대행서비스 및 관리 서비스(이하 통칭하여 ‘전자금융거래서비스’라 합니다)를 이용자가 이용하는 경우, ‘회사’와 이용자간 전자금융거래의 법률관계를 정함에 그 목적이 있습니다.</li>
                                                        </ul>
                                                    </li> 
                                                    <li>
                                                        <span class="term-head">제2조 (정의)</span>
                                                    ...
                                                    <li class="tbl-wrap tbl-col tbl-term">
                                                        <table>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td>주문/결제/배송</td>
                                                                    <td>성명, 휴대폰번호, 전자우편주소, 배송정보(주문자 및 수취인주소, 수취인명, 수취인연락처 등), 결제정보(계좌정보, 신용카드정보 등)</td>
                        ...
                        <div class="border-line-box-desc">
                            <span class="text-error has-icon">외국인은 회원가입이 불가합니다.</span>
                               ...
                               <table class="tbl-form">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <input type="text" id="mem_id" name="mem_id" placeholder="아이디를 입력해주세요.(영문자로 시작, 숫자 가능 6~20자)">

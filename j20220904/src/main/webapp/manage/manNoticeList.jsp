				...
				<div class="contents-inner contents-aside customer-wrap">
					...
					<div class="aside-wrap">
						<ol class="customer-lnb">
							...
							<li class="customer-lnb-item"><a href="productManage.jsp">상품관리</a></li>
							<li class="customer-lnb-item"><a href="#">Q&A 관리</a></li>
						</ol>
					</div>
					...
					<div class="aside-contents" align="center">
						...
						<div style="position: absolute; right: 5px; bottom: 70%;">  
							<input type="button" value="등록" onclick="location.href='manNoticeUpdateForm.do?notice_code=${notice.notice_code}&pageNum=${pageNum}'">
						</div>

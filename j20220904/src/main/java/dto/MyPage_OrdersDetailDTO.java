...
public class MyPage_OrdersDetailDTO {
	// orders_detail
	...
	public MyPage_OrdersDetailDTO() {}
	
	public MyPage_OrdersDetailDTO(int order_id, int size_num, int product_id, int cnt, int order_price, int pd_size,
	...
	public String toString() {
		return "MyPage_OrdersDetailDTO [order_id=" + order_id + ", size_num=" + size_num + ", product_id=" + product_id
				+ ", cnt=" + cnt + ", order_price=" + order_price + ", pd_size=" + pd_size + ", gender=" + gender
